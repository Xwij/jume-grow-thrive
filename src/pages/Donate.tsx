      ...
      <section className="relative pt-28 pb-20 section-padding overflow-hidden">
        ...
        <div className="container-narrow relative z-10 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-white mb-6 drop-shadow-lg">Donate to JUME College - OTEPIC Kenya</h1>
          ...
          >
            ...
            >
              ...
              <p className="font-body text-foreground/70 leading-relaxed text-sm mb-6">
                Your donation directly funds this program at JUME College - OTEPIC Kenya and Tabasamu Children's Home. Every gift, no matter the size, creates lasting change for the children, farmers and communities we serve in Trans Nzoia, Kenya.
              </p>
