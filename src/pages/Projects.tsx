...
import chFoodBevImg from "@/assets/food-and-beverage.jpeg";
...
import chWeldingImg from "@/assets/welding-fabrication.jpeg";
      ...
      {previewPdf && (
        <div className="fixed inset-0 z-[200] bg-black/85 backdrop-blur-sm flex flex-col">
          <div className="flex items-center gap-3 px-4 py-3 bg-background border-b">
            ...
            <h3 className="font-display font-semibold truncate flex-1 text-foreground">{previewPdf.title}</h3>
            <a
              href={previewPdf.pdf}
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <Eye className="w-4 h-4" /> <span className="hidden sm:inline">Open in tab</span>
            </a>
            <a
              href={previewPdf.pdf}
              download
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-9 h-9 rounded-md border border-input hover:bg-accent"
