      ...
      <div className="container-narrow">
        ...
        >
          ...
          <div className="space-y-4 text-left font-body text-muted-foreground text-sm sm:text-base leading-relaxed">
            <p>JUME College - OTEPIC Kenya is a community based not for profit organization working in Trans-Nzoia County. JUME College - OTEPIC Kenya is dedicated to promoting permaculture holistic principles to low cost, biologically based, environmentally friendly and economically viable strategies for increasing productivity for small holder farm families in order to achieve social and economic sustenance. JUME College - OTEPIC Kenya targets economically and socially disadvantaged small-scale farm families and more importantly women at the grass root level. All the capacity building work is done through JUME College - OTEPIC Kenya as an organization.</p>
            <p>JUME College - OTEPIC Kenya was initiated to tackle the problems of deforestation, soil erosion, food insecurity, high pest prevalence, bio-diversity loss, water problems and health problems. Activities include low input sustainable ecological agriculture, Bee keeping, Agroforestry, Semi zero grazing, Integrated Pest Management (IPM), Soil erosion control, Kitchen gardens and Table banking.</p>
            <p>JUME College - OTEPIC Kenya also supports young people and families in overcoming challenges such as rehabilitation, stress, family issues, drug abuse, and struggles with finding purpose in life. By unlocking the potential of African youth, JUME College - OTEPIC Kenya offers alternative path, helping them discover their purpose through education. Through JUME College - OTEPIC Kenya, individuals learn how to create their own employment opportunities and develop projects that positively impact their lives and communities.</p>
            <p>In order for JUME College - OTEPIC Kenya to reach and have a lasting impact in the community and globally, it was seen appropriate to start a training college for one day, three days, one week, three months, one year and two year craft and apprenticeship courses for farmers and college level students who have interest in farming as a career. This is how the idea of JUME College - OTEPIC Kenya was conceived. This Report highlights some of the activities that have been done and are on-going at the college.</p>
          </div>
        </motion.div>
        ...
        >
            ...
            {galleryImages.map((img, i) => (
              ...
              >
                <img
                  src={img.src}
                  alt={img.label}
                  className="w-full h-full object-contain bg-muted transition-transform duration-500 group-hover:scale-110"
                  loading="lazy"
                />
          ...
          <div>
            ...
            <p className="font-body text-muted-foreground leading-relaxed mb-3 text-sm">
              JUME College - OTEPIC Kenya was initiated to promote permaculture principles through research, training, teaching, extension and consultancy.
            </p>
